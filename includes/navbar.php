        ...
        <div x-data="{ menuOpen: false }" class="flex flex-col max-w-screen-xl  mx-auto tablet:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            ...
            <nav :class="{'flex': menuOpen, 'hidden': !menuOpen}" class="mainNav__largeNav flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row <?php echo is_page('Home') ? 'text-white' : 'text-primary' ?>">
                ...
                <div class="mainNav__dropdown" @mouseover="dropDown('Processes', true)" @mouseleave="dropDown('Processes', false)">
                    <a href="<?php echo site_url(); ?>/process" class="px-2 font-bold <?php echo is_page('Home') ? 'text-white' : 'text-primary' ?>">Processes</a>
                ...
                <div class="mainNav__dropdown" @mouseover="dropDown('Sectors', true)" @mouseleave="dropDown('Sectors', false)">
                    <a href="<?php echo site_url(); ?>/sectors" class="px-2 font-bold <?php echo is_page('Home') ? 'text-white' : 'text-primary' ?>">Sectors</a>
                ...
                <div class="mainNav__dropdown">
                    <a href="<?php echo site_url() ?>/contact" class="px-2 font-bold <?php echo is_page('Home') ? 'text-white' : 'text-primary' ?>">Contact</a>
                </div>
            </nav>
        </div>
    </div>
    <!-- Mobile menu, show/hide based on menu state. -->
    <div v-show="menuOpen" class="mobileMenu z-8 tablet:hidden" v-cloak>
        <button class="tablet:hidden focus:outline-none close" @click="menuOpen = !menuOpen">
            <svg fill="currentColor" viewBox="0 0 16 18" class="w-6 h-6">
                <path v-show="!menuOpen" fill="#000" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM9 15a1 1 0 011-1h6a1 1 0 110 2h-6a1 1 0 01-1-1z" clip-rule="evenodd"></path>
                <path v-show="menuOpen" fill="#fff" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
            </svg>
        </button>
        <ul class="px-2 sm:px-3 md:px-6 lg:px-8">
            <li><a href="<?php echo site_url() ?>/about" class="px-2 font-bold text-2xl text-white">About</a></li>
            <span></span>
            <li><a href="<?php echo site_url() ?>/process" class="px-2 font-bold text-2xl text-white">Processes</a></li>
            <span></span>
            <li><a href="<?php echo site_url() ?>/sectors" class="px-2 font-bold text-2xl text-white">Sectors</a></li>
            <span></span>
            <li><a href="<?php echo site_url() ?>/news" class="px-2 font-bold text-2xl text-white">News</a></li>
            <span></span>
            <li><a href="<?php echo site_url() ?>/vacancies" class="px-2 font-bold text-2xl text-white">Vacancies</a></li>
            <span></span>
            <li><a href="<?php echo site_url() ?>/contact" class="px-2 font-bold text-2xl text-white">Contact</a></li>
            <span></span>
